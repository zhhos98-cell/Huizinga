...
This is a waning rather than a death. In *Herfsttij* Huizinga had described old forms as fully developed even as they stiffened and lost their former relation to a living core, while warning against casting too much of death’s shadow over a waning world.[^2] *Primitive* likewise remained vigorous while more of its explanatory work moved into named relations, evidence and disciplinary judgment. Recent histories of the human sciences have shifted the question in the same direction: not simply who accepted evolution, but what a category licensed a scholar to infer.[^3] Huizinga and Malinowski met while that license was still powerful but increasingly contestable. The question could travel more easily than the warrant.
...
That is the waning that joins *primitive* to the outsider. A shared category could move between anthropology and history; evidentiary warrant and disciplinary jurisdiction moved less easily. Huizinga could use anthropology, return material to it, and help build its institutions without claiming its authority. The word *primitive* remained. More and more of the proof stood outside it.
