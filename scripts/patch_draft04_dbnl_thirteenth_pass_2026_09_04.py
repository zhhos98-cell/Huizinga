...
new = old + " In the same theses he warned that general culture-historical terms could acquire a mythological element and suffer inflation, while period names that purported to state an era’s essence could prejudge and mislead (Huizinga, 1927: 5–7)."
if text.count(old) != 1:
