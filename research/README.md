...
This branch is closed unless direct copy-level evidence appears. A copy without a Huizinga mark or documented Huizinga provenance is not worth further pursuit.

Key files include:

- `huizinga_library_malinowski_provenance.md`
- `huizinga_library_provenance_update_2026-09-04.md`
- `huizinga_three_malinowski_books_direct_search_2026-09-04.md`
- `huizinga_three_malinowski_copies_direct_delta_2026-09-04_02.md`
- `huizinga_malinowski_family_branch_2026-09-04.md`
- `cjjg_vosmaer_estate_1986_1989.md`

Do not restart generic publisher history, ordinary-copy searching or broad Vosmaer / Saint Lucas expansion.
